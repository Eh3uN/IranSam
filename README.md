...
سورس سایت تک‌صفحه‌ای آکادمی فوتبال ایران سام؛ از داستان روز اول تا معرفی مسیر جامع رشد و کارنامه پیشرفت سه‌ماهه. فارسی و راست‌به‌چپ، با رنگ‌های سرمه‌ای، نارنجی و سفید. تصاویر مستقل موبایل و دسکتاپ، فونت محلی و تمام کدها داخل پروژه هستند.
...
شش بخش فعلی، معرفی سن ۶ تا ۱۸ سال، خدمات رشد همه‌جانبه، ارزیابی هر سه ماه و دو پنل شناور مستقل ارتباط و پرسش‌های متداول پیاده شده‌اند. کارنامه، محتوای گزارش را معرفی می‌کند و شامل نمره فرضی یا پرونده شخصی بازیکن نیست. بیوگرافی/عکس/ویدئوی مربی هنوز داده واقعی ندارند و در این نسخه ساخته نشده‌اند. تماس و واتس‌اپ با شماره ارائه‌شده کارفرما فعال‌اند؛ نشانی، نقشه و ساعت پاسخ‌گویی پس از دریافت تکمیل می‌شوند. اینستاگرام فعلاً نمایش داده نمی‌شود.
